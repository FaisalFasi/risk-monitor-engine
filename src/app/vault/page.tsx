      ...
      <main className="container mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-4 sm:py-6 lg:py-8 xl:py-12">
        <div className="mb-8 sm:mb-12 lg:mb-16 xl:mb-20">
          <div className="text-center mb-6 sm:mb-8 lg:mb-12">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-2 sm:mb-3 lg:mb-4 px-2 sm:px-4 leading-tight" style={{ color: '#0f172a' }}>
              Bond.Credit Vault
            </h1>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl max-w-sm sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl mx-auto px-2 sm:px-4 leading-relaxed" style={{ color: '#475569' }}>
